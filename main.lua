...
glsounds = {
  ...
  tommusic = {
    dirt_jump = snd.load_sound{"Effects/tommusic/Dirt Jump"},
    dirt_land = snd.load_sound{"Effects/tommusic/Dirt Land"},
    stone_jump = snd.load_sound{"Effects/tommusic/Stone Jump"},
    stone_land = snd.load_sound{"Effects/tommusic/Stone Land"},
    water_jump = snd.load_sound{"Effects/tommusic/Water Jump"},
    water_land = snd.load_sound{"Effects/tommusic/Water Land"},
    wood_jump = snd.load_sound{"Effects/tommusic/Wood Jump"},
    wood_land = snd.load_sound{"Effects/tommusic/Wood Land"},
  },
  lasersword = {
    snd.load_sound{"Effects/energy-sword-swing-01"},
    snd.load_sound{"Effects/energy-sword-swing-02"},
    snd.load_sound{"Effects/energy-sword-swing-03"},
    snd.load_sound{"Effects/energy-sword-swing-04"},
    snd.load_sound{"Effects/energy-sword-swing-05"},
    snd.load_sound{"Effects/energy-sword-swing-06"},
    snd.load_sound{"Effects/energy-sword-swing-07"},
    snd.load_sound{"Effects/energy-sword-swing-08"},
    snd.load_sound{"Effects/energy-sword-swing-09"},
    snd.load_sound{"Effects/energy-sword-swing-10"},
  },
  ...
  pauseOpen = snd.load_sound{"Effects/cyrex/Modern8"},
  pauseClose = snd.load_sound{"Effects/cyrex/Modern9"},
  secret = snd.load_sound{"Effects/Oracle_Secret"},
  select = snd.load_sound{"Effects/cyrex/African4"},
  deselect = snd.load_sound{"Effects/cyrex/African3"},
  ...
  cursor = snd.load_sound{"Effects/cyrex/African2"},
  ...
  fanfareItem = snd.load_sound{"Effects/retro/bs_treasure"},
  ...
  uproot = snd.load_sound{"Effects/retro/bs_sword_swish"},
