...
glsounds = {
  footsteps = {
    soft = snd.load_sound{"Effects/footsteps/soft/SoftStep"},
    hard = snd.load_sound{"Effects/footsteps/hard/HardStep"},
    grass = snd.load_sound{"Effects/footsteps/grass/GrassStep"},
    gravel = snd.load_sound{"Effects/footsteps/gravel/GravelStep"},
    wood = snd.load_sound{"Effects/footsteps/wood/WoodStep"},
    water = snd.load_sound{"Effects/footsteps/water/WaterStep"},
    snow = snd.load_sound{"Effects/footsteps/snow/SnowStep"},
  },
  tilejump = {
    soft = snd.load_sound{"Effects/tilejump/soft/SoftJump"},
    hard = snd.load_sound{"Effects/tilejump/hard/HardJump"},
    grass = snd.load_sound{"Effects/tilejump/grass/GrassJump"},
    gravel = snd.load_sound{"Effects/tilejump/gravel/GravelJump"},
    wood = snd.load_sound{"Effects/tilejump/wood/WoodJump"},
    water = snd.load_sound{"Effects/tilejump/water/WaterJump"},
    snow = snd.load_sound{"Effects/tilejump/snow/SnowJump"},
  },
  tileland = {
    soft = snd.load_sound{"Effects/tileland/soft/SoftLand"},
    hard = snd.load_sound{"Effects/tileland/hard/HardLand"},
    grass = snd.load_sound{"Effects/tileland/grass/GrassLand"},
    gravel = snd.load_sound{"Effects/tileland/gravel/GravelLand"},
    wood = snd.load_sound{"Effects/tileland/wood/WoodLand"},
