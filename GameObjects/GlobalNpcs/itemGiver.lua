...
local myText = {
  ...
  {{{cc,cc,cc,cc},"Done! You now know: Sword, magic missile, grip, mark recall, jump and water walk(passive). You can open your inventory with space(default) and swap item positions by pressing the corresponding buttons."},-1, "left"},
